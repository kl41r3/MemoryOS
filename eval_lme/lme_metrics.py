...
def calculate_scores(data, grade_path, output_path):
    ...
    overall_metrics = {
        ...
        "context_tokens": [],
        "duration": {
            m: [] for m in ["total_duration_s", "processing_durations_s", "search_duration_s", "response_duration_s"]
        },
    }
    ...
    print("-" * 80)
    print("⏱️  \033[1mDuration Metrics (s):\033[0m")
    for m in ["response_duration_s", "search_duration_s", "total_duration_s"]:
        print(
...
if __name__ == "__main__":
    ...
    grade_path = f"demos/all_lme_grades.json"
    output_path = f"all_lme_results.xlsx"
